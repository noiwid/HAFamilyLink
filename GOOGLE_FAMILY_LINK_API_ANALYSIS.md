...
| **Set today's daily limit duration** | POST | `/kidsmanagement/v1/people/{childId}/timeLimitOverrides:batchCreate` | `[null, childId, [[null, null, 8, deviceId, null, null, null, null, null, null, null, [2, minutes, day_code]]], [1]]` | Type 8 = set daily limit duration override. **CRITICAL**: `day_code` MUST match current day (see Day Codes table below) |
| **Apply bedtime override** | POST | `/kidsmanagement/v1/people/{childId}/timeLimitOverrides:batchCreate` | `[null, childId, [[null, null, 9, null, null, null, null, null, null, null, null, null, [2, [startH, startM], [endH, endM], day_code]]], [1]]` | Type 9 = bedtime override. Format: `[status, [startHour, startMin], [endHour, endMin], day_code]`. Status 2=enabled. |
| **Set recurring bedtime window** | PUT | `/kidsmanagement/v1/people/{childId}/timeLimit:update?$httpMethod=PUT` | `[null, childId, [[null, null, null, [[day_code, [startH, startM], [endH, endM]]]], null, null, null, []], null, [1]]` | Updates the weekly bedtime window for one day. |
| **Toggle recurring bedtime day** | PUT | `/kidsmanagement/v1/people/{childId}/timeLimit:update?$httpMethod=PUT` | `[null, childId, [[null, null, [[day_code, state]], null], null, null, null, []], null, [1]]` | `state`: 2=ON, 1=OFF for the weekday. |
| **Set recurring daily limit minutes** | PUT | `/kidsmanagement/v1/people/{childId}/timeLimit:update?$httpMethod=PUT` | `[null, childId, [null, [[2, null, null, [[day_code, minutes]]]]], null, [1]]` | Updates the weekly daily limit minutes for one day. |
| **Toggle recurring daily limit day** | PUT | `/kidsmanagement/v1/people/{childId}/timeLimit:update?$httpMethod=PUT` | `[null, childId, [null, [[2, null, [[day_code, state]], null]]], null, [1]]` | `state`: 2=ON, 1=OFF for the daily limit weekday. |
| **Set recurring school time window** | N/A | N/A | N/A | Not implemented in this fork. School time schedule rows are parsed for read-only visibility, but recurring school time schedule writes were not the focus of this work and the write shape has not been verified. |
